...
(function () {
  ...
  VIZ.requiresData([
    ...
    VIZ.watchSize(function () {
      drawMap(svg, $('.container').width() / 2, $('.container').width() / 2);
    });
    ...
    var radius = 2;
    var minUnixSeconds = moment('2020/03/26 07:00 -0500', 'YYYY/MM/DD HH:m ZZ').valueOf() / 1000;
    var maxUnixSeconds = moment('2020/03/26 23:00 -0500', 'YYYY/MM/DD HH:m ZZ').valueOf() / 1000;
    ...
    function drawMap(svgContainer, outerWidth, outerHeight) {
      ...
      svg.appendOnce('text', 'time-display')
        .attr('x', svgContainer.attr('width') * 0.4)
        .attr('y', svgContainer.attr('height') * 0.15);
